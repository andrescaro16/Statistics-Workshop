...
```{r}
saldos_cuentas_corrientes_tabla <- Info_clientes_banco[Info_clientes_banco$Cuenta_corriente == 1,]
saldos_cuentas_corrientes <- saldos_cuentas_corrientes_tabla$Saldo_cuenta_corriente; saldos_cuentas_corrientes
```

```{r}
test <- c(1,2,2,2,3,4,5,9,2,3,3)
...
```{r}
# Calculemos percentiles y cuartiles
# Esta función calcula automáticamente los cuartiles
