...
**ID_cliente:** Cualitativa y nominal
...
```
* Gracias a la grafica s epuede apreciar que, de hecho, todos los asesores tienen un porcentaje de cliente mas o menos similar 
...
clientes_sin_cuenta <- Info_clientes_banco$ID_cliente[Info_clientes_banco$Cuenta_corriente == 0 & Info_clientes_banco$Cuenta_ahorros == 0]
...
>>>>>>> a3246b069488cada324d9886acbc86b342c989c3