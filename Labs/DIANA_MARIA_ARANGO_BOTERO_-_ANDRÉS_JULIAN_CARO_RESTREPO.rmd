...
```{r}
par(cex.axis=0.9)
barplot(tipo_cliente, col = "blue", main = "Tipos de clientes", xlab = "Tipos de clientes", ylab = "Valor Absoluto", cex.names=1)
par(cex.axis=0.9)
...
El asesor con mejores resultados en los saldo de cuentas corrientes es "MGOMEZ"
...
El asesor con mejores resultados en los saldo de cuentas de crédito es "NBERRIO"
...
La sucursal que mueve más dinero en los saldos de cuenta corriente es la "AMERICAS"
...
La sucursal que mueve más dinero en los saldos de cuenta corriente es la "VILLA"
